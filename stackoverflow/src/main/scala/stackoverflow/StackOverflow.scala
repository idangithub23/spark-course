...
class StackOverflow extends StackOverflowInterface with Serializable:
  ...
  def scoredPostings(grouped: RDD[(QID, Iterable[(Question, Answer)])]): RDD[(Question, HighScore)] = {
    ...
    val res = grouped.map {
      case (_, iterable) =>
        val arr = iterable.toArray
        val question = arr(0)._1
        val answers = arr.map(_._2)
  ...
  private def euclideanDistance(v1: (Int, Int), v2: (Int, Int)): Double =
    val part1 = (v1._1 - v2._1).toDouble * (v1._1 - v2._1)
    val part2 = (v1._2 - v2._2).toDouble * (v1._2 - v2._2)
    part1 + part2

  /** Return the euclidean distance between two points */
  private def euclideanDistance(a1: Array[(Int, Int)], a2: Array[(Int, Int)]): Double =
  ...
  private def findClosest(p: (Int, Int), centers: Array[(Int, Int)]): (Int, Int) =
